...
import com.codewithsameer.blog.entities.UserInfo;
...
public class UserController {
	...
	@PostMapping("/login")
	public ResponseEntity<User> signIn(@RequestBody UserInfo user) {
		
		User cc=this.userService.getByUsernameAndPassword(user.getUsername(), user.getPassword());
